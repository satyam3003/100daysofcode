...
for card in cards:
    try:
        my_dict[counter] = {
            "price": card.find_element_by_css_selector(".list-card-price").text,
            "location": card.find_element_by_css_selector("a").text,
